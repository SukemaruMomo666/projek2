...
@push('styles')
<style>
    /* ... (Semua style CSS kamu tetap di sini) ... */
    ...
    .progress-line-fill { height: 100%; background: #198754; width: 40%; transition: width 0.5s ease; }
</style>
@endpush
...
<div class="container-fluid px-4 pb-4">
            ...
            <div class="card welcome-card shadow-sm mb-4">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="mb-0 op-8">Selamat datang di Sistem Bimbingan JTIK. Terus semangat mengejar mimpimu!!!</p>
                    </div>
                    <div class="d-none d-md-block text-end">
                        <h5 class="mb-0">{{ \Carbon\Carbon::now()->translatedFormat('l, d F Y') }}</h5>
                        <small>Semester {{ Auth::user()->semester ?? 'Ganjil' }} 2025/2026</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card stat-card bg-primary text-white h-100">
                <div class="card-body">
                    ...
                    <h6 class="text-uppercase mb-2 opacity-75">Status Skripsi</h6>
                    <h3 class="fw-bold">{{ $logbooksTerkini->first()->materi ?? 'Belum Mulai' }}</h3>
                    ...
                    <small class="d-block mt-2">Progres 40%</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card stat-card bg-success text-white h-100">
                <div class="card-body">
                    ...
                    <h6 class="text-uppercase mb-2 opacity-75">Total Bimbingan</h6>
                    <h3 class="fw-bold">{{ $totalBimbingan }} Kali</h3>
                    <small class="d-block mt-4">Tercatat di Logbook</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card stat-card bg-warning text-white h-100">
                <div class="card-body">
                    ...
                    <h6 class="text-uppercase mb-2 opacity-75">Status Terkini</h6>
                    <h3 class="fw-bold">{{ $statusTerkini }}</h3>
                    <small class="d-block mt-4">Menunggu konfirmasi dosen</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card stat-card bg-danger text-white h-100">
                <div class="card-body">
                    ...
                    <h3 class="fw-bold">--/--</h3>
                    <small class="d-block mt-4">Belum dijadwalkan</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="position-relative">
                        ...
                        <div class="step-progress">
                            <div class="step-item completed"><div class="step-circle"><i class="fas fa-check"></i></div><div class="step-label">Judul</div></div>
                            <div class="step-item completed"><div class="step-circle"><i class="fas fa-check"></i></div><div class="step-label">Bab 1</div></div>
                            <div class="step-item active"><div class="step-circle">3</div><div class="step-label">Bab 2-3</div></div>
                            <div class="step-item"><div class="step-circle">4</div><div class="step-label">Bab 4-5</div></div>
                            <div class="step-item"><div class="step-circle">5</div><div class="step-label">Sidang</div></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
                    <span><i class="fas fa-history me-2 text-primary"></i> Aktivitas Bimbingan Terakhir</span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4">{{ $log->tanggal_bimbingan->format('d M Y') }}</td>
                                    <td><span class="fw-bold">{{ $log->materi }}</span><br><small class="text-muted">{{ Str::limit($log->catatan_mahasiswa, 30) }}</small></td>
                                    <td>
                                    ...
                                    <td class="text-end pe-4"><a href="{{ route('bimbingan.index') }}" class="btn btn-sm btn-light text-primary"><i class="fas fa-eye"></i></a></td>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center p-4 text-muted">
                                        Belum ada aktivitas bimbingan.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm border-0 mb-4 rounded-3">
                <div class="card-header card-header-custom">
                    <i class="fas fa-chalkboard-teacher me-2 text-primary"></i> Dosen Pembimbing
                </div>
                <div class="card-body text-center p-4">
                    ...
                    @else
                        ...
                        <p class="text-muted mb-3">Hubungi admin prodi</p>
                    @endif
                    
                    <div class="d-grid gap-2">
                        <button class="btn btn-outline-primary btn-sm rounded-pill"><i class="fab fa-whatsapp me-2"></i>Hubungi via WA</button>
                        <button class="btn btn-outline-dark btn-sm rounded-pill"><i class="fas fa-envelope me-2"></i>Kirim Email</button>
                    </div>
                </div>
            </div>
                        ...
                        <a href="{{ route('bimbingan.index') }}" class="btn btn-light text-start border hover-shadow">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Catat bimbingan baru</small>
                                </div>
                            </div>
                        </a>
                        <a href="{{ route('bimbingan.upload') }}" class="btn btn-light text-start border hover-shadow">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Kirim file revisi</small>
                                </div>
                            </div>
                        </a>
                    </div>
