...
'Dashboard')</title> 
        ...
        <!-- Styles --> 
        <link 
href="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/style.
...
me-lg-0" id="sidebarToggle" href="#!"><i class="fas 
fa-bars"></i></button> 
             
            <!-- Spacer --> 
            <div class="d-none d-md-inline-block form-inline ms-auto 
me-0 me-md-3 my-2 my-md-0"></div> 
...
route('profile.edit') }}">Profil Saya</a></li> 
...
config('app.name', 'Bimbingan JTIK') }} {{ date('Y') }}</div> 
                            <div> 
